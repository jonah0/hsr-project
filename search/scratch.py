# Messing with the code from the ipynb file for my own understanding
# 1. I want to see what the cross merge is doing
# 2. I want to see what the great_circle_two_points function is doing
...
cities_plot: gpd.GeoDataFrame = gpd.GeoDataFrame(big_cities).to_crs(epsg=3395)
cities_plot.plot(ax=states.plot(cmap='Pastel2', figsize=(50, 50)), marker='o', color='black', markersize=15)
plt.show()
